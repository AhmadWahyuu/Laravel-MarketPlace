...
<div class="dropdown mb-5">
    ...
    <ul class="dropdown-menu" style="max-height: 200px; overflow-y:scroll">
        <li><a href="/user/market" class="dropdown-item">Semua</a></li>
        <li><hr class="dropdown-divider"></li>
        @foreach($categories as $c)
            <li><a class="dropdown-item" href="/user/market?category={{ $c->slug }}">{{ $c->nama }}</a></li>
        @endforeach
    </ul>
</div>
@if ($produk->count()>0)
            ...
            @foreach ($produk->all() as $p)
                <div class="col-md-4 mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary text-right" href="/user/order/{{ $p->slug }}"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Buy</a>
                        <a href="/user/market/{{ $p->slug }}" class="text-decoration-none btn btn-primary">Selengkapnya >></a>
                    </div>
                </div>
            @endforeach
        </div>
